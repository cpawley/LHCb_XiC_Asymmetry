...
run_cmd = 'python /user/dwickrem/documents/XiC_analysis/cut_data.py'
...
run_command = f"qsub -j oe -o /data/bfys/dwickrem/sig_bkg_folder/cut_data_final_vars_sigsmall.out {submit_script}"
